...
la=language()
lianjie_image = Image.open("/home/pi/RaspberryPi-CM5/pics/lianjie@2x.png") 
weilianjie_image = Image.open("/home/pi/RaspberryPi-CM5/pics/weilianjie@2x.png")
...
def show_controller_help():
    ...
    if la == 'cn':
        ...
        text_lines = [
            ...
            ("X/B: Turning",10,190),
            ("L/R: Modes", 160,150),
            ("RK1/2:Step/speed ",160, 170),
            ("SELECT:off-road", 160,190)
        ]
