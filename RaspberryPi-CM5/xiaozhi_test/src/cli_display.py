...
display.clear()
if la=="cn":
  background_image_path = "/home/pi/RaspberryPi-CM5/xiaozhi_test/src/xiaozhi_cn.png"  # 替换为你的图片路径
else:
  background_image_path = "/home/pi/RaspberryPi-CM5/xiaozhi_test/src/xiaozhi_en.png"  # 替换为你的图片路径
